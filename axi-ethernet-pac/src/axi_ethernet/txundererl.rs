...
pub struct R(crate::R<TXUNDERERL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXUNDERERL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXUNDERERL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXUNDERERL_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of frames transmitted underrun error, LSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txundererl](index.html) module"]
