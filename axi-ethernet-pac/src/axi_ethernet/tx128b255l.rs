...
pub struct R(crate::R<TX128B255L_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX128B255L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX128B255L_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX128B255L_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of 128-255 bytes frames transmitted, LSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx128b255l](index.html) module"]
