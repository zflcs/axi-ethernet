...
pub struct R(crate::R<TX65B127L_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX65B127L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX65B127L_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX65B127L_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of 65-127 bytes frames transmitted, LSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx65b127l](index.html) module"]
