...
pub struct R(crate::R<TXBL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXBL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXBL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXBL_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Transmitted Bytes, LSW\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txbl](index.html) module"]
