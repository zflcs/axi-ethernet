...
pub struct R(crate::R<TXPFU_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXPFU_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXPFU_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXPFU_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of pause frames transmitted, MSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txpfu](index.html) module"]
