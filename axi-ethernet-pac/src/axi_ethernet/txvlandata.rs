...
pub struct R(crate::R<TXVLANDATA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXVLANDATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXVLANDATA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXVLANDATA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `txvlandata` writer"]
pub struct W(crate::W<TXVLANDATA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXVLANDATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXVLANDATA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXVLANDATA_SPEC>) -> Self {
        W(writer)
    }
}
