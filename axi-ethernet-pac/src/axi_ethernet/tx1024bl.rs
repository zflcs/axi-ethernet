...
pub struct R(crate::R<TX1024BL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX1024BL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX1024BL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX1024BL_SPEC>) -> Self {
        R(reader)
    }
}
