...
pub type R = crate::R<TX256B511L_SPEC>;
...
#[doc = "Count of 256-511 bytes frames transmitted, LSM\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tx256b511l::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
