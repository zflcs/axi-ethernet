...
pub struct R(crate::R<TXACEU_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXACEU_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXACEU_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXACEU_SPEC>) -> Self {
        R(reader)
    }
}
