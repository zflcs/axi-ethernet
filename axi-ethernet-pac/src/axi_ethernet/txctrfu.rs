...
pub struct R(crate::R<TXCTRFU_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXCTRFU_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXCTRFU_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXCTRFU_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of control frames transmitted, MSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txctrfu](index.html) module"]
