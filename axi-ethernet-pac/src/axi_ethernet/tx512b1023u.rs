...
pub struct R(crate::R<TX512B1023U_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX512B1023U_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX512B1023U_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX512B1023U_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of 512-1023 bytes frames transmitted, MSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx512b1023u](index.html) module"]
