...
pub type R = crate::R<RX256B511U_SPEC>;
...
#[doc = "Count of 256-511 bytes frames received, MSM\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rx256b511u::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
