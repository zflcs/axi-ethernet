...
pub struct R(crate::R<MDIOMIS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDIOMIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDIOMIS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDIOMIS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `mdiomis` writer"]
pub struct W(crate::W<MDIOMIS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOMIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOMIS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOMIS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MDIO_COMPLETE_W<'a, const O: u8> = crate::BitWriter<'a, MDIOMIS_SPEC, O, MDIO_COMPLETE_A>;
...
pub type PTP_TX_W<'a, const O: u8> = crate::BitWriter<'a, MDIOMIS_SPEC, O, PTP_TX_A>;
...
pub type PTP_RX_W<'a, const O: u8> = crate::BitWriter<'a, MDIOMIS_SPEC, O, PTP_RX_A>;
...
pub type PTP_TIMER_W<'a, const O: u8> = crate::BitWriter<'a, MDIOMIS_SPEC, O, PTP_TIMER_A>;
