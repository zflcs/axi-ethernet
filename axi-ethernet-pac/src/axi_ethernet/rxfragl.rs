...
pub struct R(crate::R<RXFRAGL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXFRAGL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXFRAGL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXFRAGL_SPEC>) -> Self {
        R(reader)
    }
}
