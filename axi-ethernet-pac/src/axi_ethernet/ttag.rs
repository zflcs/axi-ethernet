...
pub type R = crate::R<TTAG_SPEC>;
#[doc = "Register `ttag` writer"]
pub type W = crate::W<TTAG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vid(&mut self) -> VID_W<TTAG_SPEC, 0> {
        VID_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn cfi(&mut self) -> CFI_W<TTAG_SPEC, 12> {
        CFI_W::new(self)
    }
    #[doc = "Bits 13:15"]
    #[inline(always)]
    #[must_use]
    pub fn priority(&mut self) -> PRIORITY_W<TTAG_SPEC, 13> {
        PRIORITY_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn tpid(&mut self) -> TPID_W<TTAG_SPEC, 16> {
        TPID_W::new(self)
    }
...
#[doc = "Transmit VLAN Tag TEMAC\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ttag::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ttag::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
