...
pub struct R(crate::R<TXSCU_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXSCU_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXSCU_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXSCU_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Single Collision frames transmitted OK, MSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txscu](index.html) module"]
