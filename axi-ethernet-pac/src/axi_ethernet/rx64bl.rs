...
pub struct R(crate::R<RX64BL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX64BL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX64BL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX64BL_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Count of 64 bytes frames received, LSM\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx64bl](index.html) module"]
